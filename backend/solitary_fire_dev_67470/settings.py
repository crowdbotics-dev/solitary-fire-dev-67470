"""
Django settings for solitary_fire_dev_67470 project.
...
ROOT_URLCONF = 'solitary_fire_dev_67470.urls'
...
WSGI_APPLICATION = 'solitary_fire_dev_67470.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "solitary_fire_dev_67470 API",
    "DESCRIPTION": "API documentation for solitary_fire_dev_67470 App",
    "VERSION": "v1",
}
